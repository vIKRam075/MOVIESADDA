...
import com.example.pipapplication.databinding.ActivityFavMovieDetailsBinding
import com.example.pipapplication.utils.PreferenceManager
import javax.inject.Inject

class FavMovieDetailsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFavMovieDetailsBinding
    private var moviesResponse: FavouriteMoviesResponse? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFavMovieDetailsBinding.inflate(layoutInflater)
    ...
    private fun initView() {
        ...
        moviesResponse = intent.getParcelableExtra<FavouriteMoviesResponse>("movie")
    ...
    private fun isFavourite(moviesResponse: FavouriteMoviesResponse?): Boolean {
